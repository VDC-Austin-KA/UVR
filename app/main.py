...
async def create_job(
    ...
    eq_freq: float = Form(2500.0),
    eq_gain: float = Form(0.0),
    notch_freq: float = Form(0.0),
    notch_db: float = Form(-18.0),
    ...
    df_postfilter: bool = Form(False),
    df_strength: float = Form(100.0),
